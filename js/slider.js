// Props for this code goes to: http://jqueryfordesigners.com/coda-slider-effect/
...
jQuery(document).ready(function () {
    ...
    $scroll
        .before('<img class="scrollButtons left" src="' + image_path + 'scroll_left.png" />')
        .after('<img class="scrollButtons right" src="' + image_path + 'scroll_right.png" />');
